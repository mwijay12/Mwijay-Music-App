...
export const visualizers = [
    ...
    { id: 'aurora', name: 'Aurora', icon: 'fa-sun-haze' },
    { id: 'pulse-web', name: 'Pulse Web', icon: 'fa-circle-nodes' },
    { id: 'rainfall', name: 'Rainfall', icon: 'fa-droplets' },
    { id: 'nebula', name: 'Nebula', icon: 'fa-sparkles' },
...
export const themePairs: ThemePair[] = [
    ...
    // --- Dark Themes ---
    { name: 'Default Dark', category: 'Dark',
      light: { ...lightThemeBase, ...defaultColors('#8e44ad', '#9b59b6', '#d2b4de') },
      dark: { ...darkThemeBase, '--bg-color': '#1e1b18', ...defaultColors('#8e44ad', '#9b59b6', '#d2b4de') } },
    { name: 'Midnight Blue', category: 'Dark',
      light: { ...lightThemeBase, ...defaultColors('#013a63', '#2c7da0', '#89c2d9') },
      dark: { ...darkThemeBase, '--bg-color': '#012a4a', ...defaultColors('#2c7da0', '#89c2d9', '#a9d6e5') } },
    { name: 'Forest Green', category: 'Dark',
      light: { ...lightThemeBase, ...defaultColors('#2d6a4f', '#40916c', '#74c69d') },
      dark: { ...darkThemeBase, '--bg-color': '#1b4332', ...defaultColors('#40916c', '#74c69d', '#b7e4c7') } },
    { name: 'Dracula', category: 'Dark',
      light: { ...lightThemeBase, ...defaultColors('#bd93f9', '#ff79c6', '#f1fa8c') },
      dark: { ...darkThemeBase, '--bg-color': '#282a36', '--surface-color': '#44475a', ...defaultColors('#bd93f9', '#ff79c6', '#f1fa8c') } },
    { name: 'Slate & Ember', category: 'Dark',
      light: { ...lightThemeBase, ...defaultColors('#f97316', '#ea580c', '#fdba74') },
      dark: { ...darkThemeBase, '--bg-color': '#1e293b', '--surface-color': '#334155', ...defaultColors('#f97316', '#fb923c', '#fdba74') } },
    { name: 'Deep Forest', category: 'Dark',
      light: { ...lightThemeBase, ...defaultColors('#16a34a', '#22c55e', '#86efac') },
      dark: { ...darkThemeBase, '--bg-color': '#14532d', '--surface-color': '#166534', ...defaultColors('#22c55e', '#4ade80', '#86efac') } },

    // --- Light Themes ---
    { name: 'Classic Light', category: 'Light',
      light: { ...lightThemeBase, ...defaultColors('#4361ee', '#3a0ca3', '#03045e') },
      dark: { ...darkThemeBase, ...defaultColors('#4361ee', '#3a0ca3', '#03045e') } },
    { name: 'Sky Blue', category: 'Light',
      light: { ...lightThemeBase, ...defaultColors('#00b4d8', '#48cae4', '#023e8a') },
      dark: { ...darkThemeBase, ...defaultColors('#00b4d8', '#48cae4', '#023e8a') } },
    { name: 'Mint Green', category: 'Light',
      light: { ...lightThemeBase, ...defaultColors('#00a896', '#06d6a0', '#013220') },
      dark: { ...darkThemeBase, ...defaultColors('#00a896', '#06d6a0', '#013220') } },
    { name: 'Sunshine', category: 'Light',
      light: { ...lightThemeBase, ...defaultColors('#ffbe0b', '#ffca3a', '#141100') },
      dark: { ...darkThemeBase, ...defaultColors('#ffbe0b', '#ffca3a', '#f8f9fa') } },
    { name: 'Lavender Haze', category: 'Light',
      light: { ...lightThemeBase, '--bg-color': '#f5f3ff', ...defaultColors('#8b5cf6', '#a78bfa', '#c4b5fd') },
      dark: { ...darkThemeBase, ...defaultColors('#8b5cf6', '#a78bfa', '#c4b5fd') } },
    { name: 'Rose Gold', category: 'Light',
      light: { ...lightThemeBase, '--bg-color': '#fff1f2', ...defaultColors('#e11d48', '#f43f5e', '#fda4af') },
      dark: { ...darkThemeBase, ...defaultColors('#e11d48', '#f43f5e', '#fda4af') } },
];
