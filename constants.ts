...
export const backgroundStyles = [
    ...
    { id: 'fireflies', name: 'Fireflies', icon: 'Bug' },
    { id: 'bubbles', name: 'Bubbles', icon: 'Loader2' },
    { id: 'warpSpeed', name: 'Warp Speed', icon: 'Plane' },
    { id: 'stardust', name: 'Stardust', icon: 'Sparkles' },
    { id: 'energyFlow', name: 'Energy Flow', icon: 'Wind' },
    { id: 'twinklingStars', name: 'Twinkle Stars', icon: 'Asterisk' },
] as const;
...
const BASE_ACHIEVEMENTS: Omit<Achievement, 'criteria'>[] = [
    ...
    { id: 'listen24hours', name: '24-Hour Party Person', description: 'Accumulate 24 hours of listening time.', icon: 'Calendar', emoji: '🥳' },
    { id: 'marathon', name: 'Marathon', description: 'Listen to a song longer than 10 minutes.', icon: 'Activity', emoji: '🏃' },
    ...
    { id: 'play1000', name: 'Vinyl Veteran', description: 'Play 1,000 songs.', icon: 'CassetteTape', emoji: '📼' },
    ...
    { id: 'super_streaker', name: 'Super Streaker', description: 'Listen to music 7 days in a row.', icon: 'Zap', emoji: '☄️' },
    ...
    { id: 'use_assistant_100', name: 'AI Companion', description: 'Use the assistant 100 times.', icon: 'User', emoji: '🧑‍🚀' },
    { id: 'change_theme_3', name: 'Interior Designer', description: 'Try 3 different themes.', icon: 'Palette', emoji: '🎨' },
    { id: 'change_theme_10', name: 'Chameleon', description: 'Try 10 different themes.', icon: 'Library', emoji: '🌈' },
    ...
    { id: 'lyric_editor', name: 'Lyric Editor', description: 'Edit the lyrics for a song.', icon: 'Edit3', emoji: '📝' },
    ...
    { id: 'watch_50_reels', name: 'Binge Watcher', description: 'Watch 50 Mwijay Reels.', icon: 'Film', emoji: '🍿' },
    { id: 'ai-art-director', name: 'AI Art Director', description: 'Generate your first AI cover art.', icon: 'Wand2', emoji: '🧑‍🎨' },
    ...
    { id: 'radio_surfer', name: 'Radio Surfer', description: 'Favorite 5 radio stations.', icon: 'Radio', emoji: '📡' },
    { id: 'world_traveler', name: 'World Traveler', description: 'Listen to radio stations from 5 different countries.', icon: 'Globe', emoji: '🗺️' },
    ...
    { id: 'bpm_tapper', name: 'BPM Tapper', description: 'Use the tap-to-BPM feature in the Metronome.', icon: 'Pointer', emoji: '👆' },
    { id: 'time_bender', name: 'Time Bender', description: 'Use the A-B loop feature.', icon: 'Repeat1', emoji: '🔄' },
];
...
export const achievements: Achievement[] = BASE_ACHIEVEMENTS.map(ach => ({
    ...
    criteria: (profile: ProfileData & { librarySongs: Song[], playlists: any[] }, type: string, value: any) => {
